      ...
      <div class="page-header" id="banner">
        <div class="row">
          <div class="col-lg-8 col-md-7 col-sm-6">
           <img class="logo" src="<%=request.getContextPath() %>/resources/logo_image/독립영화 등록.png" style="margin-right:70%; width:350px; height:100px">
          </div>
        </div>
      </div>
</div>
<center>
	<form:form commandName="indeMovie" method="post" action="insertIndeMovie.look" enctype="multipart/form-data">
		<br>
		<table>
			<tr>
				<th>영화명</th>
