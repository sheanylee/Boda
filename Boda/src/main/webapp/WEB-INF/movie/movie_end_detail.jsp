      ...
      <div class="page-header" id="banner">
        <div class="row">
          <div class="col-lg-8 col-md-7 col-sm-6">
           <img class="logo" src="<%=request.getContextPath() %>/resources/logo_image/종영작.png" style="width:350px; height:100px"><br>
          </div>
        </div>
      </div>
</div>			
...
<table width="1000">
	<tr>
		...
		<td width="50%">
			<img src="<%=request.getContextPath()%>/resources/movie_image/${movieBean.m_img}" width="418.86" height="596.96">
		</td>
	</tr>
	<tr>
		<td></td>
		<td height="70px">
			<button type="button" class="btn btn-dark btn-lg">종영</button>
		</td>
	</tr>
	<tr>
		<td colspan=2>
