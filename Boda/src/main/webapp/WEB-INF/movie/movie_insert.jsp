      ...
      <div class="page-header" id="banner">
        <div class="row">
          <div class="col-lg-8 col-md-7 col-sm-6">
           <img class="logo" src="<%=request.getContextPath() %>/resources/logo_image/영화 등록.png" style="margin-right:70%; width:350px; height:100px">
          </div>
        </div>
      </div>
</div>	
<center>
	<form:form commandName="movie" method="post" action="insertMovie.look" enctype="multipart/form-data">
		<br>
		<table>
			<tr>
				<th>영화코드</th>
			...
			<tr>
				...
				<td>
					<div class="form-group">
						<input type="file" class="form-control" name="upload" id="upload" value="${movie.m_img}">
			...
			<tr>
				...
				<td>
					<div class="form-group">
						<input type="date" class="form-control" name="m_date" id="m_date" value="${movie.m_date}">
			...
			<tr>
				...
				<td>
					<div class="form-group">
						<input type="date" class="form-control" name="m_enddate" id="m_enddate" value="${movie.m_enddate}">
