<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
mypage_delete_pw_confirm.jsp <br>
...
<form role="form" action="delete_member.bd">
<table align="center">
	<tr>
		<td>
			<h5>회원 정보 탈퇴를 위해 비밀번호를 입력해주세요.</h5>
		</td>
	</tr>
	<tr>
		<td>&nbsp;</td>
	...
	<tr align="center">
		<td>
			<button type="submit" class="btn btn-primary" id="sub">회원 탈퇴</button>
		</td>
	</tr>
</table>
</form>
